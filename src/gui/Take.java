...
//				panelTake.setBackground(new Color(119,119,253));
		...
		panelTake.setOpaque(false);            //组件设置为透明;


				JLabel lblqukuan = new JLabel("请选择取款金额：");
				panelTake.add(lblqukuan);
				lblqukuan.setBounds(200, 20, 150, 30);
				
				lblqukuan=new JLabel("提示：只能是100元或100元的整数倍。");
				panelTake.add(lblqukuan);
				lblqukuan.setBounds(200, 50, 300, 30);
